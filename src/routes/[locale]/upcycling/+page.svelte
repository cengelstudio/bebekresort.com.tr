<script lang="ts">
	...
	let transformationImages = [
		{
			...
			title: 'CARAVANS',
			desc: 'Repurposed caravans transformed into cozy and unique accommodation spaces.'
		},
		{
			src: '/images/room-2.jpeg',
			title: 'CARAVAN ROOM',
			desc: 'A repurposed caravan transformed into a cozy and unique accommodation space.'
		},
		{
			src: '/images/hotel-3.jpeg',
			title: 'INDUSTRIAL REFRIGERATOR',
			desc: 'A stainless steel industrial refrigerator was repurposed as a laundry room.'
		},
		{
			src: '/images/hotel-4.jpeg',
			title: 'ASSOS STONE WALLS',
			desc: 'A stonemason used stones (Assos stone) from a ruined stone house to build a perimeter wall.'
		},
		{
			src: '/images/minivan-3.jpeg',
			title: 'TELEPHONE POLES',
			desc: 'Old telephone poles were used in the roof construction.'
		},
		{
			src: '/images/car-1.jpeg',
			title: 'NAVAL OFFICER MANNEQUIN',
			desc: 'A secondhand mannequin representing a uniformed naval officer was placed in memory of the Gallipoli Campaign.'
		}
	];
	...
	function prevSlide() {
		currentSlide =
			currentSlide === 0 ? Math.ceil(transformationImages.length / 2) - 1 : currentSlide - 1;
	}
...
<svelte:head>
	...
	<meta
		name="description"
		content="Discover our unique upcycling concept at Bebek Resort. See how we transform ordinary materials into extraordinary experiences with vintage caravans and sustainable design."
	/>
	<meta
		name="keywords"
		content="upcycling, sustainable design, Bebek Resort, vintage caravans, eco-friendly hotel, Assos Turkey, recycled materials, green tourism"
	/>

	<!-- Open Graph -->
	<meta
		property="og:title"
		content="Upcycling Concept - Bebek Resort | Sustainable Design in Assos"
	/>
	<meta
		property="og:description"
		content="Discover our unique upcycling concept at Bebek Resort. See how we transform ordinary materials into extraordinary experiences."
	/>
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://bebekresort.com.tr/upcycling" />
	<meta property="og:image" content="https://bebekresort.com.tr/images/minivan-2.jpeg" />
	...
	<meta
		...
		content="Discover our unique upcycling concept at Bebek Resort. See how we transform ordinary materials into extraordinary experiences."
	/>
	<meta name="twitter:image" content="https://bebekresort.com.tr/images/minivan-2.jpeg" />
	...
	<section class="cta-section" id="cta">
		<div class="cta-content">
			...
			<div class="cta-actions">
				<a href="mailto:info@bebekresort.com.tr" class="cta-primary large"
					>{t('upcycling.cta.bookStay')}</a
				>
			</div>
		</div>
		<div class="cta-bg" style="background-image: url('/images/minivan-2.jpeg')"></div>
...
<style>
	...
	.stats-showcase::before {
		...
		right: 0;
		bottom: 0;
		background: url('/images/minivan-5.jpeg') center/cover;
		opacity: 0.1;
	}
