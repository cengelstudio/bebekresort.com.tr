<script lang="ts">
	...
	$: heroContent = {
		...
		subtitle: $page.url.pathname.includes('/upcycling')
			...
			: t('hero.subtitle'),
		primaryBtn: $page.url.pathname.includes('/upcycling')
			? t('upcycling.hero.primaryBtn')
			: t('hero.primaryBtn'),
		primaryAction: () =>
			$page.url.pathname.includes('/upcycling')
...
<svelte:head>
	...
	<meta
		name="description"
		content="Experience sustainable luxury at Bebek Resort in Assos. Discover our unique upcycling concept with vintage caravans, mountain views, and Aegean Sea access. Book your extraordinary stay today."
	/>
	<meta
		name="keywords"
		content="Bebek Resort, Assos, luxury hotel, upcycling, sustainable tourism, vintage caravans, Aegean Sea, Kaz Mountains, Turkey, eco-friendly accommodation"
	/>
	...
	<meta
		property="og:title"
		content="Bebek Resort - Luxury Reimagined | Upcycling Paradise in Assos"
	/>
	<meta
		property="og:description"
		content="Experience sustainable luxury at Bebek Resort in Assos. Discover our unique upcycling concept with vintage caravans, mountain views, and Aegean Sea access."
	/>
	...
	<script type="application/ld+json">
		{
			...
			"image": [
				"https://bebekresort.com.tr/images/hotel-1.jpeg",
				"https://bebekresort.com.tr/images/minivan-2.jpeg",
				"https://bebekresort.com.tr/images/sea-1.jpeg"
			],
			"sameAs": ["https://instagram.com/bebekresortassos"]
		}
	</script>
</svelte:head>
			...
			<div class="nav-items {isMenuOpen ? 'open' : ''}">
				<div class="nav-links">
					...
					<a
						...
						class="nav-link {$page.url.pathname === `/${currentLang}/upcycling` ? 'active' : ''}"
						>{t('nav.upcycling')}</a
					>
				</div>
				...
				<div class="lang-selector">
					<button
						class="lang-current {isLangDropdownOpen ? 'active' : ''}"
					...
					<div class="lang-dropdown {isLangDropdownOpen ? 'open' : ''}">
						{#each languages as lang}
							<button class="lang-option" on:click={() => switchLanguage(lang.code)}>
								{lang.name}
							</button>
						{/each}
					</div>
		...
		<div class="footer-content">
			<div class="footer-grid">
				<div class="footer-section">
					<img src="/icons/logo-white.png" alt="Bebek Resort Logo" class="footer-logo" />
				...
				<div class="footer-section">
					...
					<div class="social-links">
						<a
							href="https://instagram.com/bebekresortassos"
							class="social-link"
							aria-label="Instagram"
							target="_blank"
							rel="noopener">@bebekresortassos</a
						>
					</div>
				</div>
			</div>
			...
			<div class="footer-bottom">
				...
				<div class="footer-links">
					<a href="https://cengel.studio" target="_blank" rel="noopener" class="developer-link">
						...
						<img src="/icons/cengelstudio-logo.png" alt="Cengel Studio" class="developer-logo" />
					</a>
				</div>
			</div>
		</div>
...
<style>
	...
	footer::before {
		...
		right: 0;
		bottom: 0;
		background-image: url('/images/minivan-2.jpeg');
